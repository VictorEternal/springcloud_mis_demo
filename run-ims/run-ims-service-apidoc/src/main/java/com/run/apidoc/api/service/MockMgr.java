...
public interface MockMgr {
	 ...
	 *
	 * @param id
	 *            projectId, if both pattern and options are null, this id means
	 *            actionId(used for OpenAPI)
	 * @param pattern
	 * @param options
	 * @return
	 * @throws UnsupportedEncodingException
	 */
	String generateRule(int id, String pattern, Map<String, Object> options) throws UnsupportedEncodingException;
	 ...
	 * @throws UnsupportedEncodingException
	 */
	String generateRuleData(int id, String pattern, Map<String, Object> options) throws UnsupportedEncodingException;
	 ...
	 * @throws UnsupportedEncodingException
	 */
	// String generateRuleData(int actionId) throws
	 ...
	 * @return
	 */
	String validateAPI(int projectId, String pattern, Map<String, Object> options, String jsonToCompare)
			throws UnsupportedEncodingException;
