...
public class MockjsRunner {
	...
	private String doRenderMockJsRule(String mockRule) {
		...
		try {
			...
			code.append("var result = {};").append("try {")
					// .append("var obj = Mock.mock(JSON.parse(\"" +
					// StringUtils.escapeInJ(mockRule.replaceAll("\\'", "'")) +
					// "\"));")
			...
			Object result = ct.evaluateString(scope, code.toString(), null, 1, null);
