...
import com.run.apidoc.comparator.ParameterComparator;
import com.run.apidoc.utils.StringUtils;

public class Action implements java.io.Serializable {

	private static final long	serialVersionUID		= 2129680205847466225L;
	private int					id;
	...
	private String getParameterListHTML(Set<Parameter> list) {
		...
		html.append("<table class=\"param-table\">").append("<thead>").append("<th class=\"th-name\">Name</th>")
				.append("<th class=\"th-identifier\">Identifier</th>").append("<th class=\"th-type\">Type</th>")
				.append("<th class=\"th-remark\">Remark</th>").append("</thead>");
