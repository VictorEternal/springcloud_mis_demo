...
public interface ProjectMgr {
	 ...
	 * @return
	 */
	List<Project> getProjectList(int curPageNum, int pageSize);
	 ...
	 * @return
	 */
	String updateProject(int id, String projectData, String deletedObjectListData, Map<Integer, Integer> actionIdMap);
	...
	/**
	 * clear project model cache(without project data) by projectId influence
	 * projects list
	 *
	 * @param projectId
	 */
	...
	/**
	 * clear project data cache influence workspace
	 *
	 * @param projectId
	 */
