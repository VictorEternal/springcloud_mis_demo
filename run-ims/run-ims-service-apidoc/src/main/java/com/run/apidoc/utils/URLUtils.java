...
public class URLUtils {
	public static boolean isStaticUrl(String url) {
		...
		String[] extentions = new String[] { ".jpg", ".png", ".gif", ".js", ".css", ".font", ".woff" };
	...
	public static boolean isLogUrl(String url) {
		...
		String[] keys = new String[] { "logData.action", "getUnreadNotificationList.action" };
		for (String key : keys) {
			if (url.contains(key)) {
				return true;
			}
	...
	public static boolean isMockServiceUrl(String url) {
		...
		String[] keys = new String[] { "/mockjs/", "/mock/", "/mockjsdata/" };
		for (String key : keys) {
			if (url.contains(key)) {
				return true;
			}
	...
	public static boolean isRelativeUrlExactlyMatch(String pattern, String requestUrl) {
		if (pattern == requestUrl)
			return true;
		if (pattern == null || requestUrl == null)
			return false;
